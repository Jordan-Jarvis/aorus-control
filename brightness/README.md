...
per button plus a generation marker and is updated and read back with rollback
by `aorusd`.
...
helper. Native Fn support is disabled until enabled from **Hotkeys → Laptop Fn
buttons** or:
